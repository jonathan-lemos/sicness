...
describe("SicCompiler tests", () => {
	...
	const lstExpect = [
		...
		"7    \t     \t     \t        \tVAL EQU X'1BC'",
		"8    \t10F  \t1128 \t        \t\tUSE FOO",
		"9    \t10F  \t1128 \t0F100120\tBACK +STA =4",
		"10   \t113  \t112C \t790115  \t\tSTB #ACTION",
		"11   \t116  \t112F \t872FF6  \t\tSTT BACK",
		"12   \t119  \t1132 \t12900115\t\t+STX @ACTION,X",
		...
		"24   \t     \t     \t        \t\tBASE VAL",
		"25   \t1133 \t1122 \t034F59  \t\tLDA ACTION",
		"26   \t     \t     \t        \t\tNOBASE",
		"27   \t1136 \t1125 \t030115  \t\tLDA ACTION",
	...
	const objExpect = [
		...
		"T 000115 02 AC30",
		"T 000117 01 C4",
		"T 000118 04 6F100120",
		"T 00011C 03 000ABC",
		"T 00111F 03 454F46",
		"T 001122 03 034F59",
		"T 001125 03 030115",
		"T 001128 04 0F100120",
		"T 00112C 03 790115",
		"T 00112F 03 872FF6",
		"T 001132 04 12900115",
		"T 001136 03 7D01BC",
		"E 000100",
	];
